...
Load the the [ggplot2 cheatsheet](https://rstudio.com/wp-content/uploads/2019/01/Cheatsheets_2019.pdf) and the [iris dataset](https://en.wikipedia.org/wiki/Iris_flower_data_set) to create six visualizations and combine them into a single figure. 
